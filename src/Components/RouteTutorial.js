...
export default function RouteTutorial({setCurrentMode}) {
    ...
    const script_route_list = [
        { routeName: "Cash Register" ,
          isChecked: false , 
          isExpanded: true ,
          stepList: [{length: 100 , direction: "Foward" , isChecked: false} , {length: 200 , direction: "Left" , isChecked: false}]} ,
        { routeName: "Bathroom"      ,
          isChecked: false ,
          isExpanded: true ,
          stepList: [{length: 50.5 , direction: "Backwards" , isChecked: false} , {length: 10 , direction: "Foward-Left" , isChecked: false}]}
    ]
