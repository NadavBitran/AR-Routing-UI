...
import useTooltipCoordinates from './hooks/useTooltipCoordinates';
 ...
 * @param {DataTypes.TooltipPositionRelativeToTarget}  props.positionRelativeToTarget - The position that the tooltip will be relative to the target element.
...
export default function Tooltip({
    ...
    const coordinates = useTooltipCoordinates(targetId);
        ...
        <div className="tooltip-content-overlay">
            <div
                ...
                style={{
                    ...
                    // @ts-ignore
                    '--tooltip-middleX': coordinates.middleX,
                    '--tooltip-middleY': coordinates.middleY,
                    '--tooltip-width': coordinates.width,
                    '--tooltip-height': coordinates.height,
                }}
            >
